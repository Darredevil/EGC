...
int DrawingWindow::width(800);
int DrawingWindow::height(640);
...
void DrawingWindow::keyboardFunction2(unsigned char key, int x, int y)
{
	onKeyUp(key);
}

void DrawingWindow::specialFunction2(int key, int x, int y)
{
	onKeyUp(key);
}
